...
#Heading
label_heading = Label(root, text = "Juice Centre", bg = "orange2", font=("Sylfaen",18,"bold","italic"))
...
#Label Select Fruit
label_name = Label(root, text="Select Fruit", bg = "orange2", font = ("Banschrift Light",15))
...
label_quantity = Label(root, text = "Enter Quantity", bg = "orange2", font=("Bahnscrift Light",15))
...
#Total Cost Label
label_show_amount = Label(root, bg="orange2", font=("Bahnscrift Light",12))
label_show_amount.place(relx=0.95, rely=0.8, anchor = E)
#Quantity Label
label_show_quantity = Label(root, bg="orange2", font=("Bahnscrift Light",12))
